...
void FakeUnixConsole::SetColor(int32 color)
	{
	}

void FakeUnixConsole::EnableVirtualTerminalProcessing()
	{
	}

void FakeUnixConsole::ResetTerminalFormat()
	{
	std::cout << u8"\033[0m";
	}

void FakeUnixConsole::SetVirtualTerminalFormat(FakeConsoleForeground foreground, FakeConsoleBackground background, std::set<FakeConsoleTextStyle> styles)
	{
...
void FakeUnixConsole::Clear()
	{
	std::system(u8"clear");
	}

void FakeUnixConsole::Write(const FakeString &str, FakeConsoleForeground foreground, FakeConsoleBackground background, std::set<FakeConsoleTextStyle> styles)
	{
...
void FakeUnixConsole::WriteLine(const FakeString &str, FakeConsoleForeground foreground, FakeConsoleBackground background, std::set<FakeConsoleTextStyle> styles)
	{
	Write(str, foreground, background, styles);
	std::cout << std::endl;
	}

void FakeUnixConsole::WriteLine()
	{
	std::cout << std::endl;
	}
